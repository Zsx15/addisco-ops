...
> Généré le 23 mai 2026 à 09:52:25

## 1. Résumé exécutif

| Champ | Valeur |
| --- | --- |
| Date | 23 mai 2026 09:52 |
| Utilisateur | Guilhem |
| Mode simulation | API |
| Attempts simulés | 10 |
| Régression | oui |
...
- ⚠️ Simulation : score en forte baisse (-0.177)
...
| Score moyen (après) | 0.483 |  |
| Delta score | -0.177 | ⚠️ |
| Fallback rate | 0.0% | ✅ |
| Curriculum alignment | 100.0% | ✅ |
| Coût estimé | $0.003159 |  |
| Latence moy. | 4006 ms |  |
| Non évaluables | 0 |  |
...
# Rapport simulation ADDISCO OPS — 2026-05-23 07:52 UTC
- User    : Guilhem
- Mode    : api
...
## État AVANT
- Score moyen  : 0.660
- Fragile      : resolution_problemes, comprehension_procedure, synthese_reformulation, evaluation_critique, application_regles
...
|---|-----|-------|--------|-------|------------|-----|---------|
| Q01 | 4 | question_directe | correct      | 0.20 | reponse_vague | ✓ | 5762ms |
| Q02 | 4 | question_directe | correct      | 0.00 | hors_sujet | ✓ | 3384ms |
| Q03 | 4 | cas_pratique | correct      | 0.50 | reponse_vague | ✓ | 4102ms |
| Q04 | 4 | question_directe | correct      | 0.00 | hors_sujet | ✓ | 3773ms |
| Q05 | 5 | question_directe | correct      | 0.00 | hors_sujet | ✓ | 2914ms |
| Q06 | 4 | cas_pratique | partielle    | 0.40 | reponse_vague | ✓ | 5738ms |
| Q07 | 14 | question_directe | correct      | 0.20 | reponse_vague | ✓ | 2953ms |
| Q08 | 4 | question_directe | partielle    | 0.20 | reponse_vague | ✓ | 3351ms |
| Q09 | 4 | cas_pratique | partielle    | 0.40 | reponse_vague | ✓ | 5088ms |
| Q10 | 4 | question_directe | oubli_etape  | 0.00 | hors_sujet | ✓ | 2996ms |
...
- ⚠️ Score qui chute fortement (< -0.15)
- ✅ Fallback > 20%
